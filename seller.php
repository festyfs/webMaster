...
<!-- Sidebar end=============================================== -->
	...
	<div class="row">	  
            ...
            <a href="themes/images/toko.jpg" title="Fujifilm FinePix S2950 Digital Camera">
				<img src="themes/images/toko.jpg" style="width:100%" alt="Fujifilm FinePix S2950 Digital Camera"/>
            </a>
			</div>
			<div class="span6">
				<h3>Cosme Centre Surabaya</h3>
				<small>Surabaya</small>
				<p>
					Toko hanya online. Tidak menerima COD dan pembayaran secara langsung. Terimakasih
				</p>
				<br class="clr"/>
            ...
            <ul id="productDetail" class="nav nav-tabs">
              <li class="active"><a href="#home" data-toggle="tab">Seller Information</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Seller Information</h4>
                <table class="table table-bordered">
					<tbody>
					<tr class="techSpecRow"><th colspan="2">Seller</th></tr>
					<tr class="techSpecRow"><td class="techSpecTD1">Nama Toko </td><td class="techSpecTD2">Cosme Centre Surabaya</td></tr>
					<tr class="techSpecRow"><td class="techSpecTD1">Lokasi Toko</td><td class="techSpecTD2">Surabaya</td></tr>
					<tr class="techSpecRow"><td class="techSpecTD1">Dukungan Pengiriman</td><td class="techSpecTD2">JNE, TIKI, J&T</td></tr>
					<tr class="techSpecRow"><td class="techSpecTD1">Dukungan Pembayaran</td><td class="techSpecTD2">VISA, BCA, MANDIRI
					</tbody>
				</table>
              </div>
